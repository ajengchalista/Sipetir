...
class _ManajemenUserPageState extends State<ManajemenUserPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            // --- LIST USER ---
            _buildUserCard('AF', 'Ajeng Febria', 'AjengPargoy@brantas.com', 'Admin'),
            _buildUserCard('LA', 'Lailahailla anta', 'AjengPargoy@brantas.com', 'Petugas'),
            _buildUserCard('BU', 'BUBIBU', 'AjengPargoy@brantas.com', 'Petugas'),
            _buildUserCard('HA', 'Hahaha', 'AjengPargoy@brantas.com', 'Peminjam'),
          ],
        ),
      ),
  ...
  Widget _buildUserCard(String initial, String nama, String email, String role) {
    return Container(
          ...
          Row(
            children: [
              CircleAvatar(
                ...
                radius: 25,
                child: Text(initial, style: TextStyle(color: orange, fontWeight: FontWeight.bold)),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(email, style: TextStyle(color: orange.withOpacity(0.8), fontSize: 13)),
                  ],
                ),
              ),
              Text(role, style: TextStyle(color: orange.withOpacity(0.7), fontWeight: FontWeight.w500)),
            ],
          ),
          const SizedBox(height: 15),
          Row(
            children: [
              Expanded(child: _buildActionButton(Icons.edit_note, 'Edit', orange)),
              const SizedBox(width: 10),
              Expanded(child: _buildActionButton(Icons.delete_outline, 'Hapus', Colors.red)),
            ],
          ),
        ],
      ),
